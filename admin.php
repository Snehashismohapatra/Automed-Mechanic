    	...
    	<div id="wrap">	
          ...
          <script type="text/javascript">
				...
				<p style="font-face:comic sans ms"><img src="images/b1.jpeg" height=300px width=400px style="float:left">
					...
					including autoAUTOMEDs, motorcycles, trucks, buses, coaches, and vans. The functional design and development of a modern motor vehicle is typically 
					...
					<h1 style="margin-left:470px; margin-top:-230px; margin-bottom:80px;">An auto mechanic is a mechanic with a variety of autoAUTOMED makes or either in a specific area or in a 
					specific make of autoAUTOMED. In repairing cars, their main role is to diagnose the problem accurately and quickly. They often have to 
